...
- [ ] **Step 1: 编写 `UnifiedTerminalView.tsx` 容器组件**
  实现以下功能：
...
- [ ] **Step 1: 确保切回 Web 终端时自动触发 resize/fit**
...
- [ ] **Step 2: 优化 `TerminalLogsView` 在容器内的填充高度**
