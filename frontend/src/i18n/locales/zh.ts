...
export const zh: Translations = {
  ...
  logs: {
    ...
    claudeClientReq: "客户端请求",
    geminiUpstreamReq: "上游请求",
    claudeFinalRes: "客户端响应",
    geminiUpstreamRes: "上游响应",
    clientReqTab: "客户端请求",
    upstreamReqTab: "上游请求",
    clientResTab: "客户端响应",
    upstreamResTab: "上游响应",
    ...
    copyCurl: "复制 cURL",
    copyClaudeCurl: "客户端 cURL",
    copyGeminiCurl: "上游 cURL",
    curlCopied: "cURL 已复制！",
    claudeCurlCopied: "客户端 cURL 已复制！",
    geminiCurlCopied: "上游 cURL 已复制！",
    copyJson: "复制完整 JSON",
    jsonCopied: "JSON 已复制！",
